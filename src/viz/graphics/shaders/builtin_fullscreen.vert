...
//
//   * v_uv (location 0, out here / in there) spans [0, 1] over the destination rectangle, with
...
//     Draw(3, 1, 0, 0) is the whole geometry, and v_uv is the barycentric-free trick below.
